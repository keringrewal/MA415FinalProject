...
The limitations of this data is that the forecasts are relatively short, and that means there are not many words in each and therefore ranking the weather based on these words is not completely accurate.
